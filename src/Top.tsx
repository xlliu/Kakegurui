...
<Card className="min-w-[200px]" radius="sm">
  <CardHeader className="flex gap-3 bg-default-100">
    <div className="flex flex-raw justify-between w-[100%]">
      <div className="text-md flex items-end px-1 ">Tip</div>
  ...
  {/* <div className="px-1 h-6 rounded-sm bg-default-100 flex flew-raw justify-between"> */}
    ...
    <Textarea
      ...
      defaultValue="1. This game is completely deployed on the Ton blockchain. The data on the chain is safe and transparent, ensuring game fairness."
      className="max-w"
    />
    <Textarea
      isDisabled
      ...
      labelPlacement="outside"
      // placeholder="Enter your description"
      defaultValue="2. Due to the delay in Ton block confirmation speed, the normal delay is about 30 seconds. Please wait for the list data to be refreshed after joining the game. Please do not join the game again."
      className="max-w"
    />
    <Textarea
      isDisabled
      ...
      labelPlacement="outside"
      // placeholder="Enter your description"
      defaultValue="3. Due to the high cost of blockchain data storage, after a single game is completed, the game results will be cached in the list until new players join the game, the room will be automatically reset and a new game will be started."
      className="max-w"
    />
  </div>
  </CardBody>
